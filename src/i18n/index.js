...
const resources = {
  en: {
    translation: {
      ...
      compareSubtitle: 'Compare two states side by side',
      selectTwoStates: 'Select any two states',
      selected: 'Selected',
  ...
  hi: {
    translation: {
      ...
      compareSubtitle: 'दो राज्यों की तुलना करें',
      selectTwoStates: 'किसी भी दो राज्यों का चयन करें',
      selected: 'चयनित',
      comparison: 'तुलना',
      resetSelection: 'चयन साफ़ करें',
      education: 'शिक्षा',
      tourism: 'पर्यटन',
      agriculture: 'कृषि',
      industries: 'उद्योग',
